...
const NIGHTS: Partial<Record<Locale, BlogText>> = {
  en: {
    ...
    paragraphs: [
      ...
      "The film opens in a devastated city. Ruins, rubble, empty streets, one person alone. The place stays open. That is how it should be. It can be many places at once.",
  ...
  pl: {
    ...
    paragraphs: [
      ...
      "Film zaczyna się w zniszczonym mieście. Ruiny, gruzy, puste ulice, jeden człowiek sam. Miejsce zostaje otwarte. Tak ma być. Może to być wiele miejsc naraz.",
  ...
  es: {
    ...
    paragraphs: [
      ...
      "La película empieza en una ciudad destruida. Ruinas, escombros, calles vacías, una persona sola. El lugar queda abierto. Así debe ser. Pueden ser muchos lugares a la vez.",
  ...
  fr: {
    ...
    paragraphs: [
      ...
      "Le film commence dans une ville détruite. Ruines, décombres, rues vides, un être seul. Le lieu reste ouvert. C’est ainsi. Ce peut être plusieurs lieux à la fois.",
