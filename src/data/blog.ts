...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Der Film beginnt in einer zerstörten Stadt. Ruinen, Trümmer, leere Straßen, ein Mensch allein. Der Ort bleibt offen. Genau so soll es sein. Es kann viele Orte zugleich sein.",
